...
const AuditLabel = (props) => {
    ...
    return (<span className="w-100 audit-label d-inline-flex flex-row justify-content-center align-items-center text-muted f1s-6">{text}</span>);
};

AuditLabel.defaultProps = {
    modifiedBy: "",
    modifiedOn: null,
    createdBy: "",
    createdOn: null
